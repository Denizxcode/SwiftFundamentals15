...
let myUser = User(name: "Deniz Demir", age: 39, height: 170.0, weight: 75.0, activityLevel: 7)
print("User: \(myUser.name), Age: \(myUser.age), Height: \(myUser.height) cm, Weight: \(myUser.weight) kg, Activity Level: \(myUser.activityLevel)/10")
/*:
...
print("Distance: \(mile.meters) meters = \(mile.feet) feet")
//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
let customDistance = Distance(feet: 10000) // Example distance in feet
print("Distance: \(customDistance.meters) meters = \(customDistance.feet) feet")
/*:
