...
let runningChallenges = ["Run 5 miles a week", "Sprint intervals twice a week"]
...
print(challenges[1][0])  // Prints the first element in the second challenge list
//:  All of the challenges will reset at the end of the month. Use the `removeAll` to remove everything from `challenges`. Print `challenges`.
challenges.removeAll()  // Now it works because challenges is mutable
print(challenges)
