...
var collectionDictionary: [String: [String]] = ["Shapes": shapesArray, "Colors": colorsArray]
...
if let colors = collectionDictionary["Colors"] {
    print(colors.last!)  // Force unwrapping because we are sure the array has elements
}
/*:
