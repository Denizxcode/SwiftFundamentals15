...
// friends = 200 // it gives error without commenting
print("The above code does not compile because 'friends' is a constant, and constants cannot be changed.")
...
// Deleted the line that attempts to update the constant
print("The playground now compiles properly.")
/*:
