...
schooling += 1
print("I have now completed \(schooling) years of schooling.")
...
print("The above code compiles because 'schooling' is declared as a variable (using 'var'), which allows its value to be updated.")
// End of exercise.
/*:
